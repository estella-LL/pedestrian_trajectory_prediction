...
class YOLOv3(object):
    ...
    def __call__(self, ori_img):
        ...
        bbox,cls_conf,cls_ids = bbox.numpy(), cls_conf.numpy(), cls_ids.numpy()
...
def demo():
    ...
    for filename in files:
        ...
        # # imshow
        cv2.namedWindow("yolov3_test", cv2.WINDOW_NORMAL)
        cv2.resizeWindow("yolov3_test", 600,600)
        cv2.imshow("yolov3_test",img[:, :, (2, 1, 0)])
        cv2.waitKey(0)
